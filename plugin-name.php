...
define ('PLUGIN_NAME_PLUGIN_LIBS', PLUGIN_NAME_PLUGIN_URL . 'resources/assets/libs/');

// Define a URL dos scripts do plugin
define ('PLUGIN_NAME_PLUGIN_SCRIPTS', PLUGIN_NAME_PLUGIN_URL . 'resources/assets/scripts/');

// Define a URL dos styles do plugin
define ('PLUGIN_NAME_PLUGIN_STYLES', PLUGIN_NAME_PLUGIN_URL . 'resources/assets/styles/');

// Define o PATH de views do plugin
define ('PLUGIN_NAME_PLUGIN_VIEWS', PLUGIN_NAME_PLUGIN_URI . 'resources/views/');
